        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 mb-6">
                <div class="text-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 mb-2">QR Code Check-out</h2>
                    <p class="text-gray-600">Scan QR code untuk melakukan check-out</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-red-800 font-medium mb-1">Cara menggunakan QR Code:</p>
                                <ul class="text-xs text-red-700 space-y-1">
                                    <li>• Buka aplikasi QR scanner di smartphone</li>
                                    <li>• Arahkan kamera ke QR code di atas</li>
                                    <li>• Klik link yang muncul untuk check-out</li>
                                    <li>• Konfirmasi check-out Anda</li>
                                </ul>
                            </div>
                        </div>
                    </div>
