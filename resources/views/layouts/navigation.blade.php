        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('client.pengajuan-peminjaman.index')" :active="request()->routeIs('client.pengajuan-peminjaman.*')">
                        {{ __('Pengajuan Peminjaman') }}
                    </x-nav-link>
                    @endcan
                    
                    @can('penggunaan-alat-client')
                    <x-nav-link :href="route('client.penggunaan-alat')" :active="request()->routeIs('client.penggunaan-alat')">
                        {{ __('Penggunaan Alat') }}
                    </x-nav-link>
                    @endcan
                    
                    @can('penggunaan-ruangan-client')
                    <x-nav-link :href="route('client.penggunaan-ruangan')" :active="request()->routeIs('client.penggunaan-ruangan')">
