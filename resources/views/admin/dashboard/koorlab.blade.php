            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <a href="{{ route('admin.monitoring.index') }}" class="btn btn-primary btn-block">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <ul>
                            ...
                            <li>Memantau aktivitas laboratorium</li>
                            <li>Melihat statistik sistem secara menyeluruh</li>
                        </ul>
