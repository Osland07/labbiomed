            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <ul>
                            <li>Memantau pengajuan mahasiswa yang Anda bimbing</li>
                            <li>Melihat status validasi pengajuan</li>
                            <li>Mengajukan peminjaman untuk penelitian</li>
                            <li>Menggunakan fasilitas laboratorium</li>
                            <li>Melihat riwayat aktivitas laboratorium</li>
                        </ul>
